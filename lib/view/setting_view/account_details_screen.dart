...
class _AccountDetailsScreenState extends State<AccountDetailsScreen> {
  ...
  bool _isProfilePicRemoved = false; // Tracks if the user chose to remove the photo
  ...
  ImageProvider? get _currentImageProvider {
    ...
    if (_isProfilePicRemoved) return null;
    ...
    try {
      ...
      if (pickedFile != null) {
        setState(() {
          ...
          _isProfilePicRemoved = false; // Reset flag as we have a new image
        });
      }
    } catch (e) {
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    setState(() {
                      ...
                      _isProfilePicRemoved = true; // Set flag to true
                    });
                  },
                ),
  ...
  void _onSavePressed() {
    if (_nameController.text.isEmpty ||
        ...
        _selectedYear == null ||
        gender.isEmpty) {
      SnackBarUtils.showTopSnackBar(context, "Please fill in all details.", isError: true);
      return;
    }
    showDialog(
      context: context,
  ...
  void _handleSaveChanges() async {
    ...
    try {
      await _apiService.updateUserProfile(
        ...
        profilePic: _isProfilePicRemoved 
            ? null 
            : (_profileImageFile != null
                ...
                : null),
        removeProfilePic: _isProfilePicRemoved, 
      );
      
      // CRITICAL: Refresh the user profile in the global state
      if (homePageKey.currentState != null) {
        await homePageKey.currentState!.fetchUserProfile();
      }

      if (mounted) {
        SnackBarUtils.showTopSnackBar(context, "Profile updated!");
        _onBackTap();
      }
    } catch (e) {
      if (mounted)
