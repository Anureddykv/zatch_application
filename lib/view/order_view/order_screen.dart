...
import 'package:zatch/view/home_page.dart'; // Import homePageKey
import 'package:zatch/view/order_view/track_order_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        if (homePageKey.currentState != null) {
          homePageKey.currentState!.navigateToSubScreen(TrackOrderScreen(order: order));
        } else {
          Navigator.push(
            context,
            MaterialPageRoute(
