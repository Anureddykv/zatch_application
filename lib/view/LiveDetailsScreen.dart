...
class _LiveStreamScreenState extends State<LiveStreamScreen> {
  ...
  Future<void> _initializeStream() async {
    ...
    try {
      ...
      // results[1] now returns a LiveCommentResponse wrapper
      _comments = (results[1] as dynamic).comments ?? [];
  ...
  Widget _buildProductCard(Product product) {
    return StatefulBuilder(
      builder: (context, setState) {
        ...
        void handleProceed(String action, Product product, String? selectedSize, Color? selectedColor) async {
                          ...
                          Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                              builder:
                                ...
                                bargainId: product.id, // Placeholder ID
                              ),
                            ),
                          );
                        }
