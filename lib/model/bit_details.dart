...
class Video {
  ...
  factory Video.fromJson(Map<String, dynamic> json) {
    ...
    print("🎥 Parsed Video URL: $url"); // Debug log

    return Video(publicId: json['public_id'] as String? ?? '', url: url);
  }
}
...
class Thumbnail {
  ...
  factory Thumbnail.fromJson(Map<String, dynamic> json) {
    final url = json['url'] as String? ?? '';
    print("🖼 Parsed Thumbnail URL: $url"); // Debug log

    return Thumbnail(publicId: json['public_id'] as String? ?? '', url: url);
  }
}
